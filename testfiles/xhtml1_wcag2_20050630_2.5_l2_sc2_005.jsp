...
div {
  ...
  <body><% if (errors) { %>
    <p class="error">Not all of your input could be accepted. Fields that need corrections are marked with <strong><abbr title="'needs correction'">**</abbr></strong>.</p><% } %>
    <form action="xhtml1_wcag2_20050630_2.5_l2_sc2_005.jsp" method="post">
      <p>Mandatory fields are marked with <strong><abbr title="'mandatory'">*</abbr></strong>.</p>
...
if (errorFirstNameEmpty)
{
              %><strong><abbr title="'needs correction'">**</abbr></strong> <%
}
              %><label for="firstName">First name <strong><abbr title="'mandatory'">*</abbr></strong></label></th><td><input id="firstName" name="firstName" value="<%= request.getParameter("firstName") != null ? request.getParameter("firstName") : "" %>" /></td></tr><%
...
if (errorSurnameEmpty)
{
              ...
              %><label for="surname">Surname <strong><abbr title="'mandatory'">*</abbr></strong></label></th><td><input id="surname" name="surname" value="<%= request.getParameter("surname") != null ? request.getParameter("surname") : "" %>" /></td></tr>
...
if (errorEmail)
{
              ...
              %><label for="email">Email address <strong><abbr title="'mandatory'">*</abbr></strong></label></th><td><input id="email" name="email" value="<%= request.getParameter("email") != null ? request.getParameter("email") : "" %>" /></td></tr>
          <tr><th><label for="destination">Destination <strong><abbr title="'mandatory'">*</abbr></strong></label></th><%
