...
<%! int count = 0; 
  String quote= ""; 
  String oldURL = "xhtml1_wcag2_20050630_2.2_l1_sc1_003.jsp?timeout=false";
  String timeoutStr = "";
  String newURL = "";
  String newURLtext = "";
...
if ( request.getQueryString() != null) {
  ...
  if (timeoutStr.equalsIgnoreCase("true")) {
    timeout = true;
    oldURL =  "xhtml1_wcag2_20050630_2.2_l1_sc1_003.jsp?timeout=true";
    newURL = "xhtml1_wcag2_20050630_2.2_l1_sc1_003.jsp?timeout=false";
    newURLtext = "Deactivate timeout";
    badinput = false;
  } else if (timeoutStr.equalsIgnoreCase("false")) {
    timeout = false;
    oldURL = "xhtml1_wcag2_20050630_2.2_l1_sc1_003.jsp?timeout=false";
    newURL = "xhtml1_wcag2_20050630_2.2_l1_sc1_003.jsp?timeout=true";
    newURLtext = "Activate timeout";
    badinput = false;
  } else {
    badinput = true;
    timeout = true;
  ...
  oldURL = "xhtml1_wcag2_20050630_2.2_l1_sc1_003.jsp";
  newURL = "xhtml1_wcag2_20050630_2.2_l1_sc1_003.jsp?timeout=false";
  newURLtext = "Deactivate timeout";
  badinput = false;
}
